...
<CardGroup cols={2}>
  <Card title="OpenAI account" icon="openai" href="https://openai.com">
    Required to access Codex. Available free to ChatGPT Free and Go users for a limited time.
  </Card>
  <Card title="GitHub account" icon="github" href="https://github.com">
    Required so Codex can access your copy of Signal OS.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Fork the Signal OS repo">
    Go to the Signal OS repo and click **Fork** in the top right corner, then click **Create fork**.

    This creates your own private copy under your GitHub account. Your content and `NORTHSTAR.md` stay in your fork.
  </Step>
  ...
  <Step title="Run your first skill">
    ...
    This is the system entry point — it loads Signal OS, checks the state of your repo, and tells you exactly what to do first.
