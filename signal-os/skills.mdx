...
| Skill | What it does |
|---|---|
| `/social-mission` | Brand positioning interview — **run this first**. Writes your `NORTHSTAR.md`, which every other skill reads. |
| `/social-guide` | Scans your folders and tells you exactly where you are and what to do next. Run this any time you feel lost. |
