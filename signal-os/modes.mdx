...
|---|---|---|---|
| 0 | The Long Game | SURFACE | `/social-help` |
| 1 | Brand Positioning | NORTHSTAR | `/social-mission` |
| 2 | Documentation | 2D/2R — Document step | `/social-doc` |
| 3 | Founder Story | 3-Arc Story | `/social-founder` |
| 4 | Profile Audit | Landing page approach | `/social-profile` |
| 5 | The Authority Loop | 2D/2R — Result + Reflect | `/social-result`, `/social-reflect` |
| 6 | Replies | REACT | `/social-reply` |
| 7 | Growth Content | CSPR + Article Frameworks | `/social-idea`, `/social-outline` |
| 8 | Quality | URRRCS checklist | `/social-review` |
| 9 | Flow | Idea Amplifier + Koemmandments | `/social-tweets`, `/social-cta`, `/social-publish` |
| 10 | Compound | The long game in practice | `/social-help`, `/social-archive` |
...
<AccordionGroup>
  <Accordion title="Module 0: The Long Game">
    Runs `/social-help` — scans your repo and tells you where you are in the creator journey and what to do next.
  </Accordion>
  ...
  <Accordion title="Module 6: Replies">
  ...
  <Accordion title="Module 10: Compound">
    Runs `/social-archive` or `/social-help` — moves a completed piece to archive and updates the content index.
  </Accordion>
</AccordionGroup>
